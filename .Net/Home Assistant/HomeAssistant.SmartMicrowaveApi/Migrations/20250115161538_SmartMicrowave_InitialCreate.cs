...
namespace HomeAssistant.SmartMicrowaveApi.Migrations
{
    /// <inheritdoc />
    public partial class SmartMicrowave_InitialCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    cookingMode = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SmartMicrowave", x => x.DeviceId);
                    table.ForeignKey(
                        name: "FK_SmartMicrowave_SmartDevices_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "SmartDevices",
                        principalColumn: "DeviceId",
                        onDelete: ReferentialAction.Cascade);

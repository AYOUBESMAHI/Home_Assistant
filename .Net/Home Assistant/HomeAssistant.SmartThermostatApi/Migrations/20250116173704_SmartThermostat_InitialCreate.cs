...
namespace HomeAssistant.SmartThermostatApi.Migrations
{
    /// <inheritdoc />
    public partial class SmartThermostat_InitialCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SmartThermostat", x => x.DeviceId);
                    table.ForeignKey(
                        name: "FK_SmartThermostat_SmartDevices_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "SmartDevices",
                        principalColumn: "DeviceId",
                        onDelete: ReferentialAction.Cascade);
